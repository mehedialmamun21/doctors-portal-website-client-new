...
const MediCard = ({ item }) => {
    ...
    return (
        <div className=''>
            <div className="card rounded-sm shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] mx-10 lg:mx-0">
                <figure>
                    <img
                        src={image}
                        alt="img"
                        className="hover:scale-125 duration-700 cursor-pointer"
                        style={{ height: '120px', width: '40%' }}
                    />
                </figure>

                <p className='px-2 rounded-sm py-0 mr-5 lg:mr-5 mt-5 lg:mt-5 absolute right-0 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-400 text-white'>
                    <span className='text-md'>{offpercentage}%</span> <span className='text-sm'>off</span>
                </p>


                <div className="card-body mx-auto">
                    <h2 className="card-title text-sm text-sky-600">{name}</h2>

                    <p className='text-red-500 font-semibold mx-auto'>
                        <span className='text-lg'>{price}</span> <span className='text-sm'>Tk</span>
                    </p>
                    ...
                    <center>
                        <div className="card-actions">
                            <button
                                ...
                                className="bg-yellow-500 mx-auto hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded-sm shadow-md flex items-center justify-center space-x-2"
                            >
