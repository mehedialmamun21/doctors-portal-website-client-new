...
const Navbar = () => {
  ...
  return (
    ...
    <div className="navbar bg-teal-200 px-12 py-3">
      ...
      <div className="navbar-end">
        ...
        {user ? <button className="btn btn-ghost font-bold bg-slate-600 text-white" onClick={logout} >Sign Out</button> : <Link to="/login" className="btn btn-ghost font-bold bg-slate-600 text-white">Login</Link>}
      </div>
