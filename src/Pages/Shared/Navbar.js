  ...
  return (
    ...
    <div className="navbar px-10 py-4">
      ...
      <div className="navbar-end">
        ...
        {user ? <button className="btn btn-ghost font-bold bg-slate-500 hover:bg-slate-600 text-white px-8" onClick={logout} >Sign Out</button> : <Link to="/login" className="btn btn-ghost font-bold bg-slate-500 hover:bg-slate-600 text-white px-8">Login</Link>}
      </div>
