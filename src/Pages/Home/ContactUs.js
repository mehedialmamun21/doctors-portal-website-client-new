                ...
                <div className='w-full md:w-5/12 space-y-5 text-white'>
                    <div className='flex gap-4'>
                        ...
                        <div>
                            ...
                            <p class="text-orange-400">Email us at "dentalsolution@gmail.com"</p>
                        </div>
                    </div>
                    <div>
                        <div className='flex gap-4'>
                            ...
                            <div>
                                ...
                                <p class="text-orange-400">Serving clients worldwide</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className='flex gap-4'>
                            ...
                            <div>
                                ...
                                <p class="text-orange-400">Phone : +8801521-413730</p>
                            </div>
                        </div>
                    </div>
                </div>
