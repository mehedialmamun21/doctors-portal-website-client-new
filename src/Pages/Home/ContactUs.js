            ...
            <div className='flex flex-col md:flex-row lg:flex-row px-40 pt-24 pb-16'>
                ...
                <div className='w-full md:w-5/12 space-y-5'>
                    <div className='flex gap-4'>
                        ...
                        <div>
                            <h2 className='text-2xl text-slate-600 font-semibold font-mono'>Have a Question?</h2>
                            <p class="text-slate-500 font-mono">We are here to help</p>
                            <p class="text-slate-500 font-mono">Email us at "dentalsolution@gmail.com"</p>
                        </div>
                    </div>
                    <div>
                        <div className='flex gap-4'>
                            ...
                            <div>
                                <h2 className='text-2xl text-slate-600 font-semibold font-mono'>Current Location</h2>
                                <p class="text-slate-500 font-mono">Dinajpur,Bangladesh.</p>
                                <p class="text-slate-500 font-mono">Serving clients worldwide</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className='flex gap-4'>
                            ...
                            <div>
                                <h2 className='text-2xl text-slate-600 font-semibold font-mono'>Contact With Us</h2>
                                <p class="text-slate-500 font-mono">Email: dentalsolution@gmail.com</p>
                                <p class="text-slate-500 font-mono">Phone : +8801521-413730</p>
                            </div>
                        </div>
                    </div>
                </div>
