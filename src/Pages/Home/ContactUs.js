                ...
                <div className='w-full md:w-5/12 space-y-5 text-white'>
                    <div className='flex gap-4'>
                        ...
                        <div>
                            ...
                            <p class="text-primary">Email us at "dentalsolution@gmail.com"</p>
                        </div>
                    </div>
                    <div>
                        <div className='flex gap-4'>
                            ...
                            <div>
                                ...
                                <p class="text-primary">Serving clients worldwide</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className='flex gap-4'>
                            ...
                            <div>
                                ...
                                <p class="text-primary">Phone : +8801521-413730</p>
                            </div>
                        </div>
                    </div>
                </div>
