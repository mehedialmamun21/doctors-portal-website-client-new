        ...
        <section className='featured-item bg-fixed'>
            <div className='px-0 lg:px-40'>
                <div className='mx-auto px-10 lg:px-0 lg:w-5/12 pt-10'>
                    ...
                    <p className='uppercase flex items-center justify-center py-4 text-2xl border-y-2 border-y-white lg:mt-2 lg:mb-7 font-semibold font-serif text-black'>Make an appointment today</p>
                </div>
