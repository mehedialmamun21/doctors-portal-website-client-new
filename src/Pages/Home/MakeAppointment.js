...
import appointmentPic from '../../assets/images/make_appointment.png';
    ...
    return (
        <div>
            <section style={{
                ...
                className='flex justify-center items-center py-7 px-5 lg:px-40'>
                <div className='flex-1 hidden lg:block'>
                    {/* <img className='mt-[-354px]' src={doctor} alt="" /> */}
                    <img className='h-90 flex justify-center items-center' src={appointmentPic} alt="" />
                </div>
                <div className='flex-1 lg:px-10 py-7 h-1/2'>
                    <div className='pb-14'>
                        {/* <h3 className='text-2xl text-cyan-500 pb-2 font-mono'>Appointment</h3> */}
                        <h2 className='text-4xl text-slate-700 font-mono text-center'>Make an Appointment Today</h2>
                    </div>
