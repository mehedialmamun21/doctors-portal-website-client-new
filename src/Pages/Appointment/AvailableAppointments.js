...
const AvailableAppointments = ({ date }) => {
    ...
    return (
        <section className='my-10'>
            <h4 className='text-center font-bold text-secondary text-2xl py-5 lg:py-10'>Available Appointments on <br /> <span className='text-gray-700'>{format(date, 'PP')}</span> </h4>
