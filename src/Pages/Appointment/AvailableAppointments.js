...
const AvailableAppointments = ({ date }) => {
    ...
    return (
        <section className='my-10'>
            <h4 className='text-center font-semibold text-2xl text-gray-700'>Available Appointments on <br /> <span className='text-gray-700 text-2xl'>{format(date, 'PP')}</span> </h4>
