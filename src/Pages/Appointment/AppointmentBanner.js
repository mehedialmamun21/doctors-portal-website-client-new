            ...
            <div className="hero px-5 lg:px-60 pt-24 lg:pt-20 pb-10 lg:pb-0">
                ...
                <div className="hero-content grid grid-cols-1 lg:grid-cols-3 rounded-sm text-lg text-black lg:px-36">
                    ...
                    <div className='text-center'>
                        ...
                        <span className='text-black bg-white border border-gray-300 px-5 lg:px-7 py-2 lg:py-1 rounded-sm font-mono lg:shadow-[0_3px_10px_rgb(0,0,0,0.2)] text-lg lg:text-xl'>{format(date, 'PP')}</span>
