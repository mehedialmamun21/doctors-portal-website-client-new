            ...
            <div className="hero px-5 lg:px-60 pt-24 lg:pt-20 pb-10 lg:pb-0">
                ...
                <div className="hero-content grid grid-cols-1 lg:grid-cols-3 rounded-sm text-lg text-black lg:px-36">
                    ...
                    <div className='text-center text-lg lg:text-2xl'>
                        <div className='pb-5 lg:pb-10 text-black font-mono'>Available Appointments on</div>
                        <span className='text-black bg-white px-5 lg:px-7 py-2 lg:py-2 rounded-sm font-mono lg:shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>{format(date, 'PP')}</span>
