...
const AppointmentBanner = ({ date, setDate }) => {
    return (
        ...
        <div className="hero px-5 lg:px-64 pt-10 lg:pt-10 pb-10 lg:pb-16 ">
            ...
            <div className="hero-content grid grid-cols-1 lg:grid-cols-3 rounded-sm text-lg text-slate-600 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] lg:px-36">
                ...
                <div className='text-center text-lg lg:text-2xl'>
                    <div className='pb-5 lg:pb-12 font-semibold text-slate-600 font-mono'>Available Appointments on</div>
                    <span className='text-cyan-600 px-0 lg:px-8 py-0 lg:py-3 rounded-sm font-semibold font-mono lg:shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>{format(date, 'PP')}</span>
                </div>
