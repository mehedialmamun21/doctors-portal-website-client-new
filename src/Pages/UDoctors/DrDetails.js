                ...
                <div className='px-72 pt-28'>
                    <div className='border border-zinc-400 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] '>
                        <div className='text-center'>
                            <div className='flex justify-center items-center'>
                                ...
                                <div className='pl-40'>
                                    <div className='pt-5 pb-5 bg-white border border-blue-500 rounded-sm px-10 py-3'>
                                        ...
                                        <div className='pt-2'>
                                            ...
                                            <p className='font-mono text-slate-600'> Room: {doctor.room}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='pb-5 mt-10 px-10 border border-zinc-400 shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] bg-white'>
                        <div className='pt-5 pb-5'>
                            <p className='font-mono text-slate-700'>{doctor.degree}</p>
                            <p className='text-blue-500 font-bold font-mono'> {doctor.name} </p>
                        </div>
