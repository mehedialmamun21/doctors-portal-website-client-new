    ...
    return (
        <div className='card lg:max-w-lg border border-zinc-400 shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] rounded-sm bg-white'>
            ...
            <div className="card-body py-5 pl-14 text-zinc-700">
                ...
                <div>
                    <div>
                        <p className='text-green-500 font-semibold font-mono text-lg border-b border-zinc-500 pb-1'>{doctor.name}</p>
                    </div>
                    <div>
                ...
                <div className='pt-3 flex pl-32 lg:pl-44 items-center'>
                    <p className='text-zinc-700 text-lg font-bold flex items-center'><BsArrowRight size="1.5rem" /></p>
