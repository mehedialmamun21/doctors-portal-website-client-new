                    ...
                    <div className='mb-5 lg:mb-0'>
                        <div className='mb-3'>
                            ...
                            <input
                                ...
                                className='flex justify-start mt-2 py-1 pl-2'
                            />
                        </div>

                        <div className='mb-3'>
                            <label htmlFor='test' className='flex justify-start font-bold text-sm uppercase'>
                                Tests:
                            </label>
                            <input
                                type='text'
                        ...
                        <div>
                            <label htmlFor='advice' className='flex justify-start font-bold text-sm uppercase'>
                                Advice:
                            </label>
                            <input
                                type='text'
                            ...
                            <div key={index}>
                                <div className='flex justify-start mb-5'>
                                    ...
                                    <button
                                        ...
                                        className='btn btn-ghost btn-sm bg-red-500 hover:bg-red-600 border-none text-white px-2 ml-5 rounded-sm font-mono text-sm'
                                    >
