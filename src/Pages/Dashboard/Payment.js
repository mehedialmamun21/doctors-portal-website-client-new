            ...
            <div className='w-50 max-w-xl'>
                ...
                <div class="card bg-base-200 mb-5 rounded-sm">
                    <div class="card-body">
                        ...
                        <p> <span className='font-mono'>Pay for:</span> <span className='text-blue-700 text-lg font-semibold'>{appointment.treatment}</span> </p>
                ...
                <center><BiDownArrow className='text-blue-500 text-2xl' /></center>
