...
const Payment = () => {
    ...
    return (
        <div className='mb-20'>
            ...
            <div>
                <p className='font-mono flex justify-center items-center mt-5'>Hi,<span className="text-purple-700 pl-2">{appointment.patientName}</span></p>
            </div>
                ...
                <div className='w-50 max-w-xl mt-5 px-5 lg:ml-48'>
                    ...
                    <div class="card bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] mb-5 rounded-sm">
                        <div class="card-body">
                            ...
                            <p> <span className='font-mono'>Pay for:</span> <span className='text-orange-600 font-semibold'>{appointment.treatment}</span> </p>
