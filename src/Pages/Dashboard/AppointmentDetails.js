...
//         <section>
//             <div>
//                 <h2 className='mt-24 mb-8 font-semibold border-2 border-y-zinc-400 border-x-gray-100 py-3 mx-5 lg:mx-52 text-center text-2xl'>
//                     Appointments by Treatment Category
//                 </h2>
//             </div>
...
//             <div className='my-10 text-center'>
//                 <p className='font-semibold'>
//                     <span className='border border-zinc-400 rounded-sm px-5 py-1'>
//                         <span className='text-zinc-800'>Total Appointments = {totalAppointments} ,</span>
//                         <span className='pl-5 text-blue-600 font-semibold'> Today = {todayAppointments} </span>
//                     </span>
//                 </p>
...
//             <div className='flex justify-center space-x-4 mb-5 lg:mb-10'>
//                 {Object.keys(groupedAppointments).map((treatment) => (
//                     <button
//                         key={treatment}
//                         className='text-blue-600 text-md font-semibold border bg-white px-2 py-1 rounded-md border-blue-600'
...
//                 return (
//                     <div key={treatment} ref={categoryRefs[treatment]} className='mb-10 bg-gray-200 py-0'>
