...
const MyAppointments = () => {
    ...
    return (
        <div className=''>
            <h2 className='text-xl text-center text-slate-300 bg-cyan-800 py-2 mt-12 mb-5'><span className='py-1 px-7 font-mono'>Total Appointments - {appointments.length}</span></h2>
