            ...
            <div class="drawer drawer-mobile">
                ...
                <div class="drawer-side lg:mr-3">
                    ...
                    <ul class="menu p-4 overflow-y-auto w-60 lg:w-full bg-white">
                        {!admin && <>
                            <li><Link to="/dashboard"><span className='px-4 py-3 font-bold rounded-sm shadow-lg bg-white'>My Appointments</span></Link></li>
                            <li><Link to="/dashboard/review"><span className='px-10 py-3 font-bold rounded-sm shadow-lg bg-white'>My Reviews</span></Link></li>
                        </>}
                        {admin && <>
