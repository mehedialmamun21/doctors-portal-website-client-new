...
const Contact = () => {
    ...
    return (
        <section className='h:screen'>
            ...
            <div className='flex flex-col lg:gap-12 md:flex-row lg:flex-row pt-3 lg:pt-10 lg:pb-28 px-5 lg:px-40 '>

                <div className='w-full lg:w-6/12 space-y-5'>
                    <div className='flex gap-4 shadow-2xl px-5 py-5 border'>
                        <span>
                    ...
                    <div>
                        <div className='flex gap-4 shadow-2xl px-5 py-5 border'>
                            ...
                            <div>
                                ...
                                <p class="font-semibold font-mono text-cyan-500">Phone : +8801521-413730</p>
                            </div>
                        </div>
                    </div>
