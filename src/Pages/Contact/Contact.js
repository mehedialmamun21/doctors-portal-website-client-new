...
const Contact = () => {
    ...
    return (
        <section className='h:screen'>
            ...
            <div className='flex flex-col lg:gap-24 md:flex-row lg:flex-row pt-10 lg:pt-14 lg:pb-28 px-5 lg:px-40 mb-10 lg:mb-10'>
                ...
                <div className='w-full lg:w-6/12 space-y-5'>
                    ...
                    <div>
                        <div className='flex gap-4 shadow-2xl my-4 lg:my-8 px-5 py-5 border-2 bg-cyan-600'>
                            <span>
                ...
                <div className='w-full lg:w-10/12 mt-8 lg:mt-0 text-black px-5 lg:px-24 bg-slate-300 pb-0 lg:pb-8'>
