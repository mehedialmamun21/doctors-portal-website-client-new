...
const Contact = () => {
    ...
    return (
        <section className='h:screen px-5 lg:px-5'>
            ...
            <div className='flex flex-col lg:gap-7 md:flex-row lg:flex-row py-3 lg:pt-5 lg:pb-28 px-5 lg:px-0 '>
                ...
                <div className='w-full lg:w-6/12 space-y-5'>
                    <div className='flex gap-4 shadow-2xl px-5 py-5'>
                        ...
                        <div>
                            ...
                            <p class="font-mono">We are here to help</p>
                            <p class="text-cyan-500 font-semibold font-mono">Email us at "dentalsolution@gmail.com"</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='flex gap-4 shadow-2xl px-5 py-5'>
                            ...
                            <div>
                                ...
                                <p class="font-mono">Email: dentalsolution@gmail.com</p>
                                <p class="text-cyan-500 font-semibold font-mono">Phone : +8801521-413730</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='flex gap-4 shadow-2xl px-5 py-5'>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="w-8 text-cyan-500"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path></svg>
                            </span>
                            <div>
                                <h2 className='text-2xl font-semibold font-mono'>Current Location</h2>
                                <p class="font-mono">Dinajpur,Bangladesh.</p>
                                <p class="text-cyan-500 font-semibold font-mono">Serving clients worldwide</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className='w-full mt-8 lg:mt-0 lg:w-10/12 text-black px-5 lg:px-24 pt-7 pb-8 bg-zinc-300'>
                    <div className='bg-zinc-600 px-20 py-6'>
